...
flags.DEFINE_string('data_path', "/Users/satyam/MSCS/RL/HIQL_pushT/pusht_noise/", 'Restore path.')
flags.DEFINE_string('env_name', 'pusht', 'Environment (dataset) name.')
flags.DEFINE_string('save_rollout_path', '/Users/satyam/MSCS/RL/HIQL_pushT/HIQL_pushT/impls/plots/', 'Save rollout path.')
